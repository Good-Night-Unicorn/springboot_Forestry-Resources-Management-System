...
public class GongzuorenyuanController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		...
		String token = tokenService.generateToken(u.getId(), username,"gongzuorenyuan",  "管理员" );
    ...
    public R save(@RequestBody GongzuorenyuanEntity gongzuorenyuan, HttpServletRequest request){
        if(gongzuorenyuanService.selectCount(new EntityWrapper<GongzuorenyuanEntity>().eq("gonghao", gongzuorenyuan.getGonghao()))>0) {
    ...
    public R update(@RequestBody GongzuorenyuanEntity gongzuorenyuan, HttpServletRequest request){
        //ValidatorUtils.validateEntity(gongzuorenyuan);
        if(gongzuorenyuanService.selectCount(new EntityWrapper<GongzuorenyuanEntity>().ne("id", gongzuorenyuan.getId()).eq("gonghao", gongzuorenyuan.getGonghao()))>0) {
            return R.error("工号已存在");
        }
        //全部更新
        ...
        tokenEntity.setUsername(gongzuorenyuan.getGonghao());
