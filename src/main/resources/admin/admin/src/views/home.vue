<template>
<div class="content" :style='{"minHeight":"100vh","padding":"20px 30px 20px","alignItems":"flex-start","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20240517/12e8ed177fa04da9a755241c3a8a3cad.png) no-repeat center top / cover","display":"block","width":"100%","fontSize":"14px","height":"auto"}'>
	<!-- notice -->
	<!-- title -->
	...
	<div :style='{"border":"0px solid #bababa","padding":"0","margin":"10px 0 20px","alignItems":"flex-start","color":"#333","display":"block","justifyContent":"center","overflow":"hidden","borderRadius":"0px","flexWrap":"wrap","background":"none","width":"100%","fontSize":"14px","order":"0"}'>
		<div :style='{"padding":"20px 40px 20px 0","margin":"0 1% 12px 0","borderColor":"#e7e8f8","alignItems":"center","textAlign":"center","display":"flex","float":"left","justifyContent":"space-between","borderRadius":"4px","background":"#fff","borderWidth":"0px","width":"19%","position":"relative","borderStyle":"solid"}' v-if="isAuth('linyeziyuan','首页总数')">
			...
			<div :style='{"margin":"0","alignItems":"center","textAlign":"left","flexWrap":"wrap","background":"none","display":"flex","width":"auto"}'>
				<div :style='{"padding":"0 10px","margin":"0 auto","color":"#c6cad6","borderRadius":"30px","textAlign":"center","background":"none","width":"auto","lineHeight":"1","fontSize":"36px","minWidth":"80px","fontWeight":"600","height":"auto"}'>{{linyeziyuanCount}}</div>
				<div :style='{"margin":"0","color":"#c6cad6","textAlign":"center","width":"100%","lineHeight":"24px","fontSize":"13px","height":"24px"}'>林业资源总数</div>
			</div>
		</div>
		<div :style='{"padding":"20px 40px 20px 0","margin":"0 1% 12px 0","borderColor":"#e7f8f8","alignItems":"center","textAlign":"center","display":"flex","float":"left","justifyContent":"space-between","borderRadius":"4px","background":"#fff","borderWidth":"0px","width":"19%","position":"relative","borderStyle":"solid"}' v-if="isAuth('kaifajihuashenqing','首页总数')">
			<div :style='{"alignItems":"center","background":"none","display":"flex","width":"auto","justifyContent":"center","height":"auto","order":"2"}'>
				<span class="icon iconfont " :style='{"width":"55px","fontSize":"50px","color":"#ff6c60","background":"url(http://codegen.caihongy.cn/20231106/62924b635d4748faa48f2bdd10ffa977.png) no-repeat center center","height":"38px"}'></span>
			</div>
			<div :style='{"width":"auto","margin":"0","textAlign":"left","flexWrap":"wrap","display":"flex"}'>
				<div :style='{"padding":"0 10px","margin":"0 auto","color":"#c6cad6","borderRadius":"30px","textAlign":"center","background":"none","lineHeight":"1","fontSize":"36px","minWidth":"80px","fontWeight":"600","height":"auto"}'>{{kaifajihuashenqingCount}}</div>
				<div :style='{"margin":"0","color":"#98a6ad","textAlign":"center","width":"100%","lineHeight":"24px","fontSize":"14px","height":"24px"}'>开发计划申请总数</div>
			</div>
		</div>
		<div :style='{"padding":"20px","margin":"0 1% 12px 0","borderColor":"#e7f8e8","alignItems":"center","textAlign":"center","display":"flex","float":"left","justifyContent":"center","borderRadius":"4px","background":"#fff","borderWidth":"0px","width":"19%","position":"relative","borderStyle":"solid"}' v-if="isAuth('linyezhengce','首页总数')">
			<div :style='{"alignItems":"center","background":"none","display":"flex","width":"auto","justifyContent":"center","height":"auto","order":"2"}'>
				<span class="icon iconfont " :style='{"width":"41px","fontSize":"50px","color":"#86929e","background":"url(http://codegen.caihongy.cn/20231106/dc8574d13a7642ba85cbd74dc69e5fbb.png) no-repeat center center","height":"45px"}'></span>
			</div>
			<div :style='{"width":"auto","margin":"0","textAlign":"left","flexWrap":"wrap","display":"flex"}'>
				<div :style='{"padding":"0 10px","margin":"0 auto","color":"#c6cad6","borderRadius":"30px","textAlign":"center","background":"none","lineHeight":"1","fontSize":"36px","minWidth":"80px","fontWeight":"600","height":"auto"}'>{{linyezhengceCount}}</div>
				<div :style='{"margin":"0","color":"#98a6ad","textAlign":"center","width":"100%","lineHeight":"24px","fontSize":"14px","height":"24px"}'>林业政策总数</div>
			</div>
		</div>
	</div>
	<!-- statis -->
	...
	<div class="type4" :style='{"alignContent":"flex-start","padding":"0","borderRadius":"8px","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"space-between","height":"auto","order":"10"}'>
		<div id="linyeziyuanChart1" class="echarts1" v-if="isAuth('linyeziyuan','首页统计')"></div>
		<div id="linyeziyuanChart2" class="echarts2" v-if="isAuth('linyeziyuan','首页统计')"></div>
		<div id="kaifajihuashenqingChart1" class="echarts3" v-if="isAuth('kaifajihuashenqing','首页统计')"></div>
		<div id="linyezhengceChart1" class="echarts4" v-if="isAuth('linyezhengce','首页统计')"></div>
	</div>
</div>
</template>
<script>
...
export default {
	...
	mounted(){
		this.init();
		this.getlinyeziyuanCount();
		this.linyeziyuanChat1();
		this.linyeziyuanChat2();
		this.getkaifajihuashenqingCount();
		this.kaifajihuashenqingChat1();
		this.getlinyezhengceCount();
		this.linyezhengceChat1();
	},
	methods:{
		// 统计图动画
		...
		getlinyeziyuanCount() {
			this.$http({
				url: `linyeziyuan/count`,
				method: "get"
			}).then(({
				data
			}) => {
				if (data && data.code == 0) {
					this.linyeziyuanCount = data.data
				}
			})
		},
// 1234 饼2
        ...
        var linyeziyuanChart1 = echarts.init(document.getElementById("linyeziyuanChart1"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                linyeziyuanChart1.setOption(option);
				
                  //根据窗口的大小变动图表
									window.addEventListener('resize', () => {
										linyeziyuanChart1.resize();
									})
            }
        });
      })
    ...
    linyeziyuanChat2() {
      this.$nextTick(()=>{
        ...
        var linyeziyuanChart2 = echarts.init(document.getElementById("linyeziyuanChart2"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                linyeziyuanChart2.setOption(option);
				
                  //根据窗口的大小变动图表
                window.addEventListener('resize', () => {
										linyeziyuanChart2.resize();
								})
            }
        });
      })
		...
		getkaifajihuashenqingCount() {
			this.$http({
				url: `kaifajihuashenqing/count`,
				method: "get"
			}).then(({
				data
			}) => {
				if (data && data.code == 0) {
					this.kaifajihuashenqingCount = data.data
				}
			})
		},
// 1234 竖
		kaifajihuashenqingChat1() {
			this.$nextTick(()=>{

        var kaifajihuashenqingChart1 = echarts.init(document.getElementById("kaifajihuashenqingChart1"),'macarons');
        this.$http({
            url: "kaifajihuashenqing/group/kaifajindu",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                for(let i=0;i<res.length;i++){
                    ...
                    xAxis.push(res[i].kaifajindu);
                    yAxis.push(parseFloat((res[i].total)));
                    pArray.push({
                        value: parseFloat((res[i].total)),
                        name: res[i].kaifajindu
                    })
                }
                var option = {};
                ...
                // 使用刚指定的配置项和数据显示图表。
                kaifajihuashenqingChart1.setOption(option);
				
                  //根据窗口的大小变动图表
									window.addEventListener('resize', () => {
										kaifajihuashenqingChart1.resize();
									})
            }
        });
      })
		...
		getlinyezhengceCount() {
			this.$http({
				url: `linyezhengce/count`,
				method: "get"
			}).then(({
				data
			}) => {
				if (data && data.code == 0) {
					this.linyezhengceCount = data.data
				}
			})
		},
// 1234 横
        ...
        var linyezhengceChart1 = echarts.init(document.getElementById("linyezhengceChart1"),'macarons');
        this.$http({
            url: "linyezhengce/group/zhengceleixing",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                for(let i=0;i<res.length;i++){
                    ...
                    xAxis.push(res[i].zhengceleixing);
                    yAxis.push(parseFloat((res[i].total)));
                    pArray.push({
                        value: parseFloat((res[i].total)),
                        name: res[i].zhengceleixing
                    })
                }
                var option = {};
				let titleObj = this.bar.title
                ...
                // 使用刚指定的配置项和数据显示图表。
                linyezhengceChart1.setOption(option);
				
                  //根据窗口的大小变动图表
									window.addEventListener('resize', () => {
										linyezhengceChart1.resize();
									})
            }
        });
      })
