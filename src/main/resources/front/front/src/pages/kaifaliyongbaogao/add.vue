    ...
    >
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="林地名称" prop="lindimingcheng">
            <el-input v-model="ruleForm.lindimingcheng" 
                placeholder="林地名称" clearable :disabled="true  ||ro.lindimingcheng"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="林地类型" prop="lindileixing">
            <el-input v-model="ruleForm.lindileixing" 
                placeholder="林地类型" clearable :disabled="true  ||ro.lindileixing"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="区域" prop="quyu">
            <el-input v-model="ruleForm.quyu" 
                placeholder="区域" clearable :disabled="true  ||ro.quyu"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="林地面积" prop="lindimianji">
            <el-input v-model="ruleForm.lindimianji" 
                placeholder="林地面积" clearable :disabled="true  ||ro.lindimianji"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="开发时间" prop="kaifashijian">
              <el-date-picker
				  :disabled="true  ||ro.kaifashijian"
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}'  label="开发结果" prop="kaifajieguo">
            <el-select v-model="ruleForm.kaifajieguo" placeholder="请选择开发结果" :disabled=" false  ||ro.kaifajieguo" >
              <el-option
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="林业局名称" prop="linyejumingcheng">
            <el-input v-model="ruleForm.linyejumingcheng" 
                placeholder="林业局名称" clearable :disabled="true  ||ro.linyejumingcheng"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="开发内容" prop="kaifaneirong">
            <editor 
...
<script>
  export default {
    ...
    // 多级联动参数
      // 多级联动参数
      info() {
        this.$http.get(`kaifaliyongbaogao/detail/${this.$route.query.id}`, {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
			...
			this.$refs["ruleForm"].validate(valid => {
				if(valid) {
					...
					if(crossrefid && crossuserid) {
						...
						this.$http.get('kaifaliyongbaogao/list', {
							params: params
						}).then(res => {
							if(res.data.data.total>=crossoptnum) {
								...
								this.$http.post(`kaifaliyongbaogao/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(res => {
									if (res.data.code == 0) {
										this.$message({
											message: '操作成功',
											type: 'success',
