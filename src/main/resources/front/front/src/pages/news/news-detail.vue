<template>
	...
	<div :style='{"width":"100%","overflow":"hidden","flexWrap":"wrap","background":"#fff","justifyContent":"space-between","display":"flex"}'>
		<div :style='{"margin":"10px 0 0","textAlign":"center","background":"url(http://codegen.caihongy.cn/20230921/eb4b56c7d55142c4b9339e032022bfb5.png) repeat-x center bottom","display":"none","width":"calc(100% - 0px)","lineHeight":"56px","height":"66px"}'>
			<div :style='{"margin":"0 auto","color":"#333","textAlign":"center","background":"none","display":"inline-block","width":"auto","fontSize":"20px","fontWeight":"500"}'>林业资讯</div>
		</div>
		<div :style='{"minHeight":"360px","padding":"20px","background":"none","flex":"1","width":"calc(100% - 230px)","position":"relative","order":"2"}'>
			<div  :style='{"margin":"0 0 10px","lineHeight":"40px","fontSize":"22px","color":"#333","textAlign":"center","fontWeight":"600"}'>{{detail.title}}</div>
			
			<div :style='{"alignItems":"center","color":"#999","background":"none","display":"flex","width":"100%","fontSize":"14px","position":"relative","justifyContent":"flex-end"}'>
			  <div :style='{"padding":"0","margin":"0 10px 0 0","position":"absolute","left":"0"}'>
			    <span class="icon iconfont icon-shijian22" :style='{"margin":"0 2px 0 0","lineHeight":"1.5","fontSize":"inherit","color":"inherit"}'></span>
		...
		<!-- option -->
		<div :style='{"padding":"0 20px","margin":"20px 0","display":"flex","width":"calc(100% - 0px)","justifyContent":"center","height":"auto","order":"10"}'>
		  <div :style='{"margin":"0 50px 0 0","lineHeight":"40px","fontSize":"14px","color":"#666"}' @click="prepDetailClick">上一篇：prev</div>
		  <div :style='{"color":"#666","lineHeight":"40px","fontSize":"14px"}' @click="nextDetailClick">下一篇：next</div>
		</div>

		<!-- 热门文章 -->
		<div class="hot" :style='{"width":"200px","margin":"30px 30px 0 0","background":"#fff","height":"auto","order":"1"}'>
		  <div :style='{"color":"#fff","borderRadius":"30px","textAlign":"center","background":"#28890b","width":"100%","lineHeight":"40px","fontSize":"14px"}'>热门文章</div>
		  <div :style='{"width":"100%","padding":"0 0 5px 0","margin":"10px 0 0","background":"#fff","height":"auto"}'>
		    <div v-for="item in hotList" :key="item.id" :style='{"width":"100%","padding":"5px 0px 0","background":"#fff","height":"auto"}' @click="toDetail(item.id)">
		      <img :style='{"width":"100%","objectFit":"cover","display":"block","clipPath":"polygon(0% 0%, 95% 0, 100% 50%, 95% 100%, 0% 100%)","height":"120px"}' :src="baseUrl + item.picture" alt="">
		      <div :style='{"padding":"4px 5px 0","overflow":"hidden","whiteSpace":"nowrap","color":"#666","width":"100%","lineHeight":"30px","fontSize":"14px","textOverflow":"ellipsis","height":"30px"}'>{{ item.title }}</div>
